...
class SAE(BaseDictionaryLearning):
    ...
    def __init__(
        ...
        # we initialize the encoder to the transpose of the decoder [Scaling and evaluating sparse autoencoders]
        if not pretrained:
            initializer = self.encoder.final_block[0].weight
        else:
            initializer = None
